...
export const PRODUCT_DETAIL_OTHER_SOLUTION_TITLE = 'Other solutions';
export const PRODUCT_DETAIL_OTHER_SOLUTION_BODY = `Stand-alone solutions, 
lorem ipsum dolor sit amet, adisplicing sit ame`;
